...
function viewAvailableCars(){
            ...
            <div class="col-list-3" style="float: none; height: 200px; width: 240px;">
            <div class="recent-car-list" style="border-radius: 10px; " >
            <div class="car-info-box" style="float: left;"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" class="img-responsive" alt="image"></a>
            <ul>
...
{       ?>  
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="update.php?vhhid=<?php echo htmlentities($result->vhid);?>" style="background-color: #555555 !important;" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Ret</a>
                    </tr>
                    <?php $cnt=$cnt+1; }} ?>
                    </form>
                  </tbody>
